...
const PERFUMES = [
  ...
  { id:"acqua-fico", name:"피코 디 아말피", brand:"아쿠아 디 파르마", en:"Acqua di Parma Fico di Amalfi", gender:"유니섹스", price:240000,
    top:["bergamot","lemon","grapefruit"], middle:["fig","jasmine"], base:["cedar","musk"],
    desc:"아말피 해안의 무화과잎, 싱그럽고 청량한 여름향" },
  { id:"acqua-arancia", name:"아란치아 디 카프리", brand:"아쿠아 디 파르마", en:"Acqua di Parma Arancia di Capri", gender:"유니섹스", price:240000,
    top:["orange","mandarin","lemon"], middle:["cardamom"], base:["caramel","musk"],
    desc:"카프리섬의 햇살 오렌지, 달콤상큼한 시트러스" },
  { id:"acqua-magnolia", name:"마그놀리아 노빌레", brand:"아쿠아 디 파르마", en:"Acqua di Parma Magnolia Nobile", gender:"여성", price:260000,
    top:["bergamot","lemon"], middle:["magnolia","peony"], base:["sandalwood","vanilla"],
    desc:"우아한 목련의 화사하고 고급스러운 플로럴" },
  { id:"acqua-rosa", name:"로사 노빌레", brand:"아쿠아 디 파르마", en:"Acqua di Parma Rosa Nobile", gender:"여성", price:260000,
    top:["bergamot"], middle:["rose","peony","violet"], base:["musk","amber"],
    desc:"갓 핀 장미 정원을 거니는 듯한 로맨틱 로즈" },
  { id:"acqua-essenza", name:"콜로니아 에센자", brand:"아쿠아 디 파르마", en:"Acqua di Parma Colonia Essenza", gender:"남성", price:250000,
    top:["bergamot","lemon","grapefruit"], middle:["rosemary","geranium"], base:["vetiver","oakmoss","leather"],
    desc:"콜로니아의 진한 버전, 더 깊고 우디한 시트러스" },
  { id:"acqua-oud", name:"콜로니아 오드", brand:"아쿠아 디 파르마", en:"Acqua di Parma Colonia Oud", gender:"유니섹스", price:360000,
    top:["bergamot","cardamom"], middle:["rose","saffron"], base:["oud","sandalwood","amber"],
    desc:"시트러스에 우드를 더한 고급스럽고 관능적인 향" },
  { id:"acqua-bergamotto", name:"베르가모토 디 칼라브리아", brand:"아쿠아 디 파르마", en:"Acqua di Parma Bergamotto di Calabria", gender:"유니섹스", price:240000,
    top:["bergamot","grapefruit"], middle:["ginger","pepper"], base:["vetiver","musk"],
    desc:"칼라브리아 베르가못의 톡 쏘는 청량한 시트러스" },
